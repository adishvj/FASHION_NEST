import 'package:ecommerce_mobile_app/screens/Cart/payment_method.dart';
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Text(
                        'Contact Information:',
                        style: TextStyle(
                            fontFamily: "Airbnb", color: Colors.white),
                      ),
                      ListTile(
                        title: TextFormField(
                      ...
                      Text(
                        'Payment Method:',
                        style: TextStyle(
                            fontFamily: "Airbnb", color: Colors.black),
                      ),
                      Row(
                        children: [
                          ElevatedButton(
                        ...
                        onPressed: () {
                          if (_formKey.currentState!.validate()) {
                            showDialog(
                              ...
                              builder: (context) => AlertDialog(
                                title: Text('Success'),
                                content: Image.asset("images/Frame 271.png"),
                                actions: <Widget>[
                                  TextButton(
                                    onPressed: () {
